    ...
    public partial class upDataBase : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__19093A0B12B32348", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__InvoiceS__C8EE2063B74CDE81", x => x.StatusId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PaymentM__DC31C1D3FEB9E358", x => x.PaymentMethodId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Power = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    PowerSource = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    ...
                    IsDiscontinued = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "((0))")
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Products__B40CC6CDBF58A32B", x => x.ProductId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Comments__C3B4DFCA9B5E0D6A", x => x.CommentId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__Comments__Produc__440B1D61",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__ProductI__7516F70CF1FBF9B2", x => x.ImageId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Shopping__51BCD7B7A342901A", x => x.CartId);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK__ShoppingC__Produ__5165187F",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__PaymentL__5E5486488C848839", x => x.LogId);
                    table.ForeignKey(
                        name: "FK__PaymentLo__Payme__5BE2A6F2",
